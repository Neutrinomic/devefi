...
actor class({ledgerId: Principal}) = self {
    ...
    // public shared ({caller}) func icrc55_modify_node_old(vid : ICRC55.LocalNodeId, req : ?ICRC55.NodeModifyRequest, creq : ?Tex.ModifyRequest) : async Node.ModifyNodeResp<Tex.Shared> {
    //     nodes.icrc55_modify_node(caller, vid, req, creq);
    //     //NEW
    //     //public func icrc55_modify_node(caller, vid, nreq : ?ICRC55.CommonModRequest, custom : ?XModifyRequest) : ModifyNodeResp<XShared>
    // };

    public shared ({caller}) func icrc55_modify_node(vid : ICRC55.LocalNodeId, req : ?ICRC55.CommonModRequest, creq : ?Tex.ModifyRequest) : async Node.ModifyNodeResp<Tex.Shared> {
        nodes.icrc55_modify_node(caller, vid, req, creq);
        //NEW
        //public func icrc55_modify_node(caller, vid, nreq : ?ICRC55.CommonModRequest, custom : ?XModifyRequest) : ModifyNodeResp<XShared>
    };
