...
module {
    ...
    public class VectorModules(m: {
        ...
        public func toShared(mid :Node.ModuleId, id : Node.NodeId) : Result.Result<Shared, Text> {
        ...
        public func getDefaults(mid:Node.ModuleId) : CreateRequest {
        ...
        public func authorAccount(mid: Node.ModuleId) : ICRC55.Account {
        ...
        public func sources(mid :Node.ModuleId, id : Node.NodeId) : Node.PortsDescription {
        ...
        public func destinations(mid :Node.ModuleId, id : Node.NodeId) : Node.PortsDescription {
        ...
        public func create(id:Node.NodeId, req : CreateRequest) : Result.Result<Node.ModuleId, Text> {
        ...
        public func modify(mid :Node.ModuleId, id:Node.NodeId, creq : ModifyRequest) : Result.Result<(), Text> {
            switch (creq) {
        ...
        public func nodeMeta(mid :Node.ModuleId) : ICRC55.NodeMeta {
        ...
        public func nodeBilling(mid :Node.ModuleId) : ICRC55.Billing {
